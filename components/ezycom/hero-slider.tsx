...
export default function EzyComHeroSlider() {
  ...
  return (
    <div className="relative w-full max-w-lg aspect-[4/3] sm:aspect-video lg:aspect-[4/3] rounded-3xl overflow-hidden border border-slate-200/80 shadow-[0_20px_50px_rgba(0,0,0,0.08)] bg-white">
      {/* Glow highlight */}
